...
export const Icons = {
  ...
  GoogleDrive: () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-white">
      <path d="M8.036 20.25l-4.524-7.838H12.6l4.525 7.838H8.036zM4.777 11.237L8.691 4.5h7.839l-3.914 6.737H4.777zM17.82 18.963l3.915-6.738L13.896 4.5H6.056l7.839 13.575 3.925.888z" />
    </svg>
  ),
  Gmail: () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-white">
